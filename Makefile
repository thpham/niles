...
buildVersionVar=github.com/thpham/niles/internal/version.BuildVersion
buildCommitVar=github.com/thpham/niles/internal/version.BuildCommit

# various directories
bindirs=$(wildcard ./cmd/*)
installdir=build/niles-$(version)

# list of files to include in build
bins=$(notdir $(bindirs))
readme=README.md
templates=
config=./cmd/niles/niles.conf
